...
Rails.application.config.assets.precompile += %w( css/bootstrap-wysihtml.css )
...
Rails.application.config.assets.precompile += %w( js/wysihtml.min.js )
Rails.application.config.assets.precompile += %w( js/bootstrap-wysihtml.min.js )
