...
$(document).ready(function() {
	...
	var wn_n = n.parent();
        n.is(".active") ? (n.removeClass("active active-sm"), $("ul:first", n).slideUp(function() {
            e()
        })) : (n.parent().is(".child_menu") || ($SIDEBAR_MENU.find("li").removeClass("active active-sm"), $SIDEBAR_MENU.find("li ul").slideUp()), wn_n.children('li').removeClass("active") ,n.addClass("active"), $("ul:first", n).slideDown(function() {
            e()
        }))
    }),
...
$(document).ready(function() {
    ...
    function() {
        ...
        t = $(this).find("i"),
        n = e.find(".x_content");
        e.attr("style") ? n.slideToggle(200,
        function() {
            e.removeAttr("style")
